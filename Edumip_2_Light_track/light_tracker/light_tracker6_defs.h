/**
 * rc_balance_team2_defs.h
 *
 * Contains the settings for configuration of rc_balance_team2.c
 */
...
#define BOARD_MOUNT_ANGLE	0.27 // increase if mip tends to roll forward
...
#define N_co           -0.015519
#define K_co         {-1.033835, -0.060517, -0.057738}
