/**
 * rc_balance_teamx_defs.h
 *
 * Contains the settings for configuration of rc_balance_teamx.c
 */
...
#define BOARD_MOUNT_ANGLE	0.365// increase if mip tends to roll forward
...
//MPU
#define SENSOR_FUSION_T		1.0

//Constante
#define PI  3.141592
//Observateur réduit
#define L		{-0.000423, -0.079352, -0.005029}
#define A21_LA11		{-0.916521, 0.262388, 0.005029}
#define B2_LB1 			4.455692
#define A22_LA12 		0.811936

//controleur sans action intégral
#define N_co		-0.0031
#define K_co		{-1.0301, -0.0974, -0.0483}

#define K_cod {-0.9237, -0.0345, -0.0164, -0.0532}
#define N_cod -0.0164
